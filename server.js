...
// Route untuk menampilkan data secara lengkap
app.get('/', (req, res) => {
    res.json(motoGP);
});

// Route untuk menampilkan data berdasarkan pengelompokan negara
...
// Route untuk menampilkan data berdasarkan pengelompokan nama pemenang
